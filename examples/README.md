...
- **[d3mopd](./d3mopd)**: Reference launch layout for **D³-MOPD** — multi-teacher, multi-domain on-policy distillation with a dynamic per-batch mixture ratio driven by per-domain KL signals. This is the primary contribution of this repository.
