...
### AMD Support ###
SLIME_DIR="${SLIME_DIR:-/path/to/slime}" # Default path if not set in environment
export SLIME_DIR

MODEL_DIR="${MODEL_DIR:-/path/to/model}" # Default path if not set in environment
export MODEL_DIR

DATA_DIR="${DATA_DIR:-/path/to/data}"  # Default path if not set in environment
export DATA_DIR
